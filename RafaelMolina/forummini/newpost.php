                ...
                <div class="card-body">
                    ...
                    <form action="code.php" method="post" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                <label for="">Contem Spoilers?</label>
                                <select name="spoiler" required class="form-control">
                                    <option value="yes">Yes</option>
                                    <option value="no">No</option>
                                </select>    
                            </div>
                            <div class="col-md-12 mb-3">
                                <label for="">Contem Conteudo Maturo?(+18)</label>
                                <select name="mature" required class="form-control">
                                    <option value="yes">Yes</option>
                                    <option value="no">No</option>
                                </select>    
                            </div>
                            ...
                            <div class="col-md-12 mb-3">
                                <button type="submit" name="newpost" class="btn btn-primary">Save Post</button>
                            </div>
                        </div>
                    </form>
                </div>
